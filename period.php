								...
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form method="POST">
											...
											$sql = "INSERT INTO visitas_supervisor (nombre, Proposito, Fecha, Horario, HorarioSalida, Evidencia) 
													VALUES ('$ct', '$proposito', '$fecha', '$horario_entrada', '$horario_salida', '$evidencia')";
											...
											<div class="form-group">
												...
												<option>Aplicación de ficha de observación a director</option>
												<option>Aplicación de ficha de observación a docentes</option>
												<option>Atencion a padres de familia</option>
												<option>Atencion a conflicto</option>
												<option>Tutoria a director</option>
											...
											<div class="form-group">
												...
												<option>Ficha de director</option>
												<option>Ficha de observacion docente</option>
												<option>Acta</option>
