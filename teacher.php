	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-male-alt zmdi-hc-fw"></i> Supervisor <small> Registro</small></h1>
			</div>
			<p class="lead">Añade un nuevo supervisor con facilidad. Completa los campos necesarios con la información del supervisor y asegúrate de incluir detalles precisos. ¡Gracias por contribuir a nuestro sistema educativo!</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
