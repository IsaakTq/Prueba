...
<html lang="es">
<head>
	<title>Validacion y planificacion</title>
	<meta charset="UTF-8">
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-font zmdi-hc-fw"></i>Validacion y planificacion<small> Registro</small></h1>
			</div>
			<p class="lead">Aquí podrás registrar la validacion y planificacion. Completa la información requerida y asegúrate de proporcionar detalles precisos. ¡Gracias por tu colaboración!</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
										<form method="POST">
											...
											$sql = "INSERT INTO validacion_planificacion (nombre, Fecha, GradoGrupo, Sugerencias) 
													VALUES ('$ct', '$fecha', '$grado_grupo', '$sugerencias')";
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
												...
												<input class="form-control" type="text" name="sugerencias">
											  </div>
										    <p class="text-center">
