...
<html lang="es">
<head>
	<title>Visitas de director a aulas de docentes</title>
	<meta charset="UTF-8">
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Visitas de director a aulas de docentes <small> Registro</small></h1>
			</div>
			<p class="lead">Aquí podrás registrar las visitas de los directores a las aulas de los docentes. Completa la información requerida y asegúrate de proporcionar detalles precisos. ¡Gracias por tu colaboración!</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form method="POST">
											...
											$sql = "INSERT INTO visitas_director (nombre, Proposito, Fecha, GradoGrupo, Evidencia) 
													VALUES ('$ct', '$proposito', '$fecha', '$grado_grupo', '$evidencia')";
											...
											<div class="form-group">
												...
												<option>Aplicacion de ficha de observacion</option>
												<option>Acompañamiento docente</option>
												<option>Atencion a padres de familia</option>
											...
											<div class="form-group">
												...
												<option>Bitacora de observacion</option>
