			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="RegistroSupervisor.php"><i class="zmdi zmdi-timer zmdi-hc-fw"></i> Visitas supervisor</a>
						</li>
						<li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Administrador <small> Registro</small></h1>
			</div>
			<p class="lead">
				Añade un nuevo administrador con facilidad. Completa los campos necesarios con la información del administrador y asegúrate de incluir detalles precisos. ¡Gracias por contribuir a nuestro sistema educativo!</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
