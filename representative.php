	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-male-female zmdi-hc-fw"></i> Docente <small> Registro</small></h1>
			</div>
			<p class="lead">Añade un nuevo Docente con facilidad. Completa los campos necesarios con la información del docente y asegúrate de incluir detalles precisos. ¡Gracias por contribuir a nuestro sistema educativo!</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
